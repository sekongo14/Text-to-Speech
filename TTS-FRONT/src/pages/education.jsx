...
function Education() {
    return (
        <div className="container">
            <h1>Text to Speech <span>Convertisseur</span></h1>
                ...
                <div className="speech-parameters mt-2">
                    ...
                    <div className="row">
                        <div className="input-group mb-2 input-range-diy col-lg-6">
                            ...
                            <input type="range" className="custom-range" id="speech-speed" max="3" min="0" step="0.01" value="1" />
                            <div className="input-group-append">
                                <span className="input-group-text" id="speech-speed-text">x1</span>
                            </div>
                        </div>
                    </div>
                </div>
